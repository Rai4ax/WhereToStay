...
namespace WhereToStay.data.migrations
{
    ...
    [Migration("20230115222018_update_fields_3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhereToStay.Models.HotelRooms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WhereToStay.Models.Hotel_Img", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WhereToStay.Models.HotelRooms", b =>
                {
                    b.HasOne("WhereToStay.Models.Hotel", null)
                        .WithMany("HotelRoomID")
                        .HasForeignKey("hotel_id");

                    b.HasOne("WhereToStay.Models.Room", null)
                        .WithMany("RoomsHotelID")
            ...
            modelBuilder.Entity("WhereToStay.Models.Hotel_Img", b =>
                {
                    b.HasOne("WhereToStay.Models.Hotel", null)
                        .WithMany("Hotel_ImgID")
                        .HasForeignKey("hotel_id");

                    b.HasOne("WhereToStay.Models.Image", null)
                        .WithMany("Img_HotelID")
                        .HasForeignKey("image_id");
                });
            ...
            modelBuilder.Entity("WhereToStay.Models.Hotel", b =>
                {
                    ...
                    b.Navigation("HotelRoomID");

                    b.Navigation("Hotel_ImgID");
                });

            modelBuilder.Entity("WhereToStay.Models.Image", b =>
                {
                    b.Navigation("Img_HotelID");
                });
