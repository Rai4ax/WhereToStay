...
namespace WhereToStay.data.migrations
{
    ...
    [Migration("20230115223459_update_fields_5")]
    partial class updatefields5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelImage", b =>
                {
                    b.Property<int>("Hotel_ImgIDimage_id")
                        .HasColumnType("integer");

                    b.Property<int>("Img_HotelIDhotel_id")
                        .HasColumnType("integer");

                    b.HasKey("Hotel_ImgIDimage_id", "Img_HotelIDhotel_id");

                    b.HasIndex("Img_HotelIDhotel_id");
            ...
            modelBuilder.Entity("HotelRoom", b =>
                {
                    b.Property<int>("HotelRoomIDroom_id")
                        .HasColumnType("integer");

                    b.Property<int>("RoomsHotelIDhotel_id")
                        .HasColumnType("integer");

                    b.HasKey("HotelRoomIDroom_id", "RoomsHotelIDhotel_id");

                    b.HasIndex("RoomsHotelIDhotel_id");
            ...
            modelBuilder.Entity("HotelImage", b =>
                {
                    b.HasOne("WhereToStay.Models.Image", null)
                        .WithMany()
                        .HasForeignKey("Hotel_ImgIDimage_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WhereToStay.Models.Hotel", null)
                        .WithMany()
                        .HasForeignKey("Img_HotelIDhotel_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HotelRoom", b =>
                {
                    b.HasOne("WhereToStay.Models.Room", null)
                        .WithMany()
                        .HasForeignKey("HotelRoomIDroom_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WhereToStay.Models.Hotel", null)
                        .WithMany()
                        .HasForeignKey("RoomsHotelIDhotel_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
