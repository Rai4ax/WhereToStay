...
namespace WhereToStay.data.migrations
{
    ...
    [Migration("20230115224953_update_fields_6")]
    partial class updatefields6
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelImage", b =>
                {
                    b.Property<int>("hotel_image_id")
                        .HasColumnType("integer");

                    b.Property<int>("img_hotel_id")
                        .HasColumnType("integer");

                    b.HasKey("hotel_image_id", "img_hotel_id");

                    b.HasIndex("img_hotel_id");
            ...
            modelBuilder.Entity("HotelRoom", b =>
                {
                    b.Property<int>("hotelR_room_id")
                        .HasColumnType("integer");

                    b.Property<int>("rooms_hotel_id")
                        .HasColumnType("integer");

                    b.HasKey("hotelR_room_id", "rooms_hotel_id");

                    b.HasIndex("rooms_hotel_id");
            ...
            modelBuilder.Entity("HotelImage", b =>
                {
                    b.HasOne("WhereToStay.Models.Image", null)
                        .WithMany()
                        .HasForeignKey("hotel_image_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WhereToStay.Models.Hotel", null)
                        .WithMany()
                        .HasForeignKey("img_hotel_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HotelRoom", b =>
                {
                    b.HasOne("WhereToStay.Models.Room", null)
                        .WithMany()
                        .HasForeignKey("hotelR_room_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WhereToStay.Models.Hotel", null)
                        .WithMany()
                        .HasForeignKey("rooms_hotel_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
